...
_STATUS_MAP: dict[type[DomainError], int] = {
    ...
    InvalidSupervisorError: 400,
    ReturnExceedsLoadedError: 400,
    StageStateError: 400,
    ItemHasTransactionsError: 400,
    UserHasTransactionsError: 400,
    UserHasCheckedOutToolsError: 409,
    NegativeQuantityError: 400,
    NoChangeError: 400,
    BillingQuantityError: 400,
    DuplicateToolBarcodeError: 400,
    ToolHasOutstandingCustodyError: 400,
    ToolReturnExceedsCheckedOutError: 400,
