# UX Review Archive — completed July 2026 items

The per-item detail and browser-validation evidence for every UX finding that
shipped in the July 2026 review. **Split out of `docs/ux-review.md` on
2026-08-10**, when it had grown to 84% of that file.

Nothing here was edited in the move. For the findings that are **still open**,
see `docs/ux-review.md` or the index in `docs/open-work.md`.
